...
function Menu({ selectedPage }: PropsTypes) {
    ...
    return (
        <div className="p-3 h-screen box-border">
            <div className='bg-white w-96 h-full rounded-[12px] p-6 drop-shadow-2xl'>
                ...
                <div className='h-full flex flex-col justify-between'>
                    <div className='flex flex-col'>
                        ...
                        <Link to='/admin/fixtures' className='menuLink flex items-center py-3 px-3 mb-3 duration-300 gap-3 rounded-[6px] hover:bg-red'>
                            ...
                            <p className='text-dark text-4 font-normal block'>Fixtures List</p>
                        </Link>
                    </div>

                    <div className='border-t-[1px] border-slate-600 pb-10 mt-auto'>
                        <Link to='/admin/settings' className='flex items-center py-3 px-3 mb-3 duration-300 gap-3 rounded-[6px] my-4 hover:bg-red'>
